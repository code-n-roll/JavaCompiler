...
class TokenInfo {
    ...
    /** Column in which the token occurs in the source file. */
    private int column;
    ...
    public TokenInfo(TokenKind kind, String image, int line, int column) {
        this.kind = kind;
        this.image = image;
        this.line = line;
        this.column = column;
    ...
    public TokenInfo(TokenKind kind, int line, int column) {
        this(kind, kind.toString(), line, column);
    }
    ...
    /**
     * Return the column number associated with the token.
     *
